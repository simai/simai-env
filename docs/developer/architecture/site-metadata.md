...
Use this document when you need the concrete metadata block layout written into site configs.

Why it matters:

- this is the exact field-level contract for metadata version 2,
- admin commands and drift checks parse these fields directly,
- changes here affect real backward compatibility.
