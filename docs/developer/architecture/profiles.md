...
- **bitrix**: PHP 1C-Bitrix site; DB required; cron supported (`cron_events.php`); healthcheck enabled.
...
See also:
- `docs/developer/development/how-to-add-profile.md` for a step-by-step guide and checklist.
- `docs/developer/architecture/profiles-spec.md` for full field definitions.
