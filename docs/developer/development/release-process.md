...
1. Update code and ensure behavior changes are reflected in docs (`docs/developer/architecture/*`, `docs/developer/commands/*`, `docs/developer/admin.md`, `README.md`).
...
5. For interactive menu changes, review `docs/developer/development/menu-ux-audit.md` and record the affected scenario(s) before/after the change.
