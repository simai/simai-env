...
Run with `sudo /root/simai-env/simai-admin.sh queue <command> [options]`.

Use this doc when you need:

- Laravel queue worker status,
- restart behavior and safety checks,
- recent managed worker logs.
