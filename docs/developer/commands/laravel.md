...
Run with `sudo /root/simai-env/simai-admin.sh laravel <command> [options]`.

Use this doc when you need:

- Laravel lifecycle state and setup stages,
- bootstrap and finalize behavior,
- Laravel-specific optimization and readiness checks.
