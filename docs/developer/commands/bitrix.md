...
Run with `sudo /root/simai-env/simai-admin.sh bitrix <command> [options]`.

Use this doc when you need:

- Bitrix lifecycle and installer preparation,
- managed cron and agents-over-cron behavior,
- Bitrix-specific optimization, finalize, and cache workflows.
