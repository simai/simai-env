...
For profile-specific command selection, see `docs/developer/operations/profile-ops-matrix.md`.
For menu-driven everyday work, start with `docs/user/README.md`.
