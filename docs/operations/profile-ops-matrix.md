...
- Main checks: `bitrix status`, `bitrix cron-status`, `site doctor`, `ssl status`.
- Typical actions: `bitrix cron-sync`, `bitrix cache-clear`, SSL lifecycle commands, DB rotate/export.
